...
::: {.center-caption}
![ Four screenshots from the VoiceIn app, showing the welcome page, sample project, sample question, and thank you page.](../assets/VoiceIn.png){width=30% fig-align="center" fig-cap="VoiceIn App"}
:::
