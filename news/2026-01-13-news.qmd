...
subtitle: "Digital skills are now essential for research. The Catalyst helps you build them faster and more effectively."
format:
  html:
    toc: false
    echo: false
...
<ul class="indent-list">
  <li>📅 Discover relevant courses and resources</li>
  <li>🔍 Navigate digital learning pathways</li>
  <li>💻 Access curated, high-quality training materials</li>
  <li>👩‍💻 Build skills aligned with real research needs</li>
</ul>

<ul class="icon-list">
  <li><i class="fa-regular fa-calendar"></i> Discover relevant courses and resources</li>
  <li><i class="fa-solid fa-magnifying-glass"></i> Navigate digital learning pathways</li>
  <li><i class="fa-solid fa-laptop-code"></i> Access curated, high-quality training materials</li>
  <li><i class="fa-solid fa-user-gear"></i> Build skills aligned with real research needs</li>
</ul>
...
<br>
<p> Access tailored support exactly when you need it with Digital Research Specialists who can help you:
  </p>
...
<br>
<p>Training events are delivered on an ad hoc basis, both online and in person. These engaging sessions are often free or offered at a reduced cost, and are led by experienced instructors passionate about sharing their expertise.</p>
<p> Upcoming events: </p>
  <ul>
